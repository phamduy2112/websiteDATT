...
export default function Toogle() {
  ...
  return (
    <div className="py-[1rem]">
      ...
      >
        <div className="mt-4 w-[100%] p-6 rounded-lg border border-gray-100 ">
          ...
          <div className="checkout-account-toggle w-[400px] open-toggle2 mb-30 mt-[1rem]">
            <input
              className="h-[45px] w-[100%] border border-gray-200 px-[1rem] text-[.8rem] focus:outline-[#266bf9] mb-[1rem]"
            ...
            />
            <button
              className="btn-hover checkout-btn text-white bg-[#266bf9] h-[45px] px-[1rem] mt-[1rem] text-[0.8rem]"
              type="submit"
            >
              Login
            </button>
        ...
        >
          <div className="mt-4 w-[100%] p-6 rounded-lg border border-gray-100 ">
            ...
            <div className=" w-[400px] flex gap-[.5rem] mb-30 mt-[1rem]">
              ...
              <button
                className=" text-white bg-[#266bf9] text-[.8rem] px-[1rem] h-[45px]"
                type="submit"
              >
                Submit
              </button>
